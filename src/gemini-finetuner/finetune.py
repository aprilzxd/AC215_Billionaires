...
TRAIN_DATASET = "gs://finance_215/reddit_1000/train.jsonl" # Replace with your dataset
VALIDATION_DATASET = "gs://finance_215/reddit_1000/test.jsonl" # Replace with your dataset
...
def train(wait_for_job=False):
    ...
    sft_tuning_job = sft.train(
        ...
        tuned_model_display_name="finance-215-v2",
    )
